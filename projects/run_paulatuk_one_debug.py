...
WIND_PRODUCTION_CSV = str(
    ROOT_DIR
    / "data"
    / "test"
    / "normalized_production"
    / "ie0124_paulatuk_wind_normalized_20yr_1min.csv"
)
...
OUTPUT_NAME = "paulatuk debug run psis"
...
PSIS_WIND_SHUTDOWN_MARGIN_RATIO = 0.10 # Additional margin for shutting down wind turbines
PSIS_WIND_SHUTDOWN_PERSISTENCE_HR = 0.25 # Minimum time that the wind turbine must cover the load before diesel generators are turned off
